...
Users.hasMany(Tickets, { foreignKey: "userId", as: "userTickets" });

Tickets.belongsTo(Users, { foreignKey: "assignedTo", as: "assignedAgent" });
Tickets.belongsTo(Users, { foreignKey: "userId", as: "user" });
...
sequelize
  ...
  .then(async () => {
    try {
      console.log(
        "Database connection has been established successfully. Running seeds..."
      );
...
export { sequelize, Users, Tickets, Categories, Urgency };
