  ...
  try {
    ...
    try {
      ...
      const deptsRes = await sequelize.query(
        `INSERT INTO department (dept_name) VALUES ('IT Support'), ('Customer Service'), ('Billing'),('Help Desk') RETURNING *;`,
        { transaction: t }
      );
      ...
      await sequelize.query(
        ...
        ('Account Access', ${urgencyMap['Medium']});`,
        { transaction: t }
      );
      ...
      const usersRes = await sequelize.query(
        ...
        ('Support', 'Agent', 'support@agent.com', '${hashedPassword}', ${rolesMap['Agent']}),
        ('Billling', 'Agent', 'billing@agent.com', '${hashedPassword}', ${rolesMap['Agent']}),
      ...
      await sequelize.query(
        ...
        (${userMap['support@agent.com']}, ${deptMap['Customer Service']}),
        (${userMap['billing@agent.com']}, ${deptMap['Billing']});`,
        { transaction: t }
      );
