...
import { PlusCircle, FileText, User, Tag } from 'lucide-react';

const menuItems = [
  { name: 'My Tickets', href: '/dashboard/customer', icon: FileText },
  { name: 'Create Ticket', href: '/dashboard/customer/create', icon: PlusCircle },
  { name: 'Profile', href: '/profile', icon: User },
  { name: 'Categories', href: '/dashboard/customer/categories', icon: Tag },
];
